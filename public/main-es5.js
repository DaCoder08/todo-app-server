...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, http) {
        ...
        this.http.get("/todos/getAll", { headers: headers }).subscribe(function (data) {
            data["todos"].forEach(function (element) {
                element.completed = false;
                _this.todos.push(element);
            });
        });
    }
    ...
    DashboardComponent.prototype.addTodo = function (todo) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            "Content-Type": "application/json",
            "auth": localStorage.getItem("id_token")
        });
        this.http.post("/todos/add", { "title": todo.value }, { headers: headers }).subscribe(function (data) {
            _this.todos.push(data["todo"]);
        });
        todo.value = "";
    };
    DashboardComponent.prototype.deleteTodo = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            "Content-Type": "application/json",
            "auth": localStorage.getItem("id_token")
        });
        this.http.post("/todos/delete/" + id, {}, { headers: headers }).subscribe(function (data) {
            window.location.reload();
        });
    };
    DashboardComponent.prototype.onToggle = function (todo) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(ngFlashMessageService, http, router) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.http.post("/users/auth", user, { headers: headers }).subscribe(function (res) {
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(ngFlashMessageService, router) {
        this.ngFlashMessageService = ngFlashMessageService;
        this.router = router;
        this.loggedIn = false;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(vs, ngFlashMessageService, http, router) {
        this.vs = vs;
        this.ngFlashMessageService = ngFlashMessageService;
        this.http = http;
        this.router = router;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.vs.validateRegister(user)) {
            ...
            this.http.post("/users/add", user, { headers: headers }).subscribe(function (res) {
                _this.ngFlashMessageService.showFlashMessage({
